...
///
/// The app ships five sounds (default / gentle / warning / bhutan / spain).
/// The catalog
...
/// `alarmSoundCustom1` / `alarmSoundCustom2`. The
...
class AlarmSoundCatalog {
  ...
  static const List<AlarmSound> all = <AlarmSound>[
    ...
    AlarmSound(id: 'bhutan', assetPath: 'assets/sounds/alarm_bhutan.mp3'),
    AlarmSound(id: 'spain', assetPath: 'assets/sounds/alarm_spain.mp3'),
  ];
