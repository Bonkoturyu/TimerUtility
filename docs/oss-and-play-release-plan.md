...
| T10 | GitHub Settings → Visibility を Public に変更 + Description / Topics 設定 | GitHub Web | **必須** (不可逆) |
...
4. シークレットウィンドウで Public URL アクセス → README 表示 / LICENSE バッジ表示
5. Pixel 6a 実機: 既存挙動に回帰なし
