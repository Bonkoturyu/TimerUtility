...
**最終結果**: T1〜T9 を PR #67 (2026-05-16) で main マージ、T8.5/T8.6 を 2026-05-27 omit (PR #69 で計画書反映、判断根拠は [docs/dev-log.md](dev-log.md) 「Phase 11.8 T8.5 / T8.6 omit 決定」セクション)、T10 を 2026-05-27 ユーザ実施で完全クローズ。詳細は [docs/dev-log.md](dev-log.md) 「Phase 11.8 完全クローズ — T10 (Public 化) 完了 (2026-05-27)」セクション参照。
