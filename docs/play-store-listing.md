...
状態: 草稿。Phase 11.10-T2 で Play Console 公式仕様を WebFetch で再確認した上で、
T3 で確定値に差し替える前提
...
```text
Multi-timer, scheduled alarms, world clock, and lock-screen alarms. Built for Android 16.
```
...
| --- | --- | --- | --- |
| アプリアイコン (高解像度) | 必須 | 512 × 512 PNG、32-bit、1 MB 以内 | `design/icon/play-store-512.png` |
| Feature graphic | 推奨 | 1024 × 500 PNG / JPEG | `design/screenshots/feature-graphic.png` |
| スクリーンショット (スマホ) | 2 枚以上 | 横幅 1080 px 以上、最大 8 枚 | `design/screenshots/phone/*.png` |
...
4. Closed Testing の 20 人 14 日ルールの個人アカウント適用範囲
