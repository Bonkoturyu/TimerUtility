...
- [~] Play Store 提出準備（Phase 11.9 γ）:
  ...
  残りは
  Play Console 実画面での listing / Data Safety 確定、
...
| 11 (その他) | 進行中 | 設定画面 4 項目 (PR #36) + CVD 冗長表示 (PR #39) + 言語手動切替 UI (2026-05-14) + 通知 channel 名 i18n (PR #59、2026-05-16) + F-7 Manifest 整形 (PR #59) + A-3 中韓 ARB 本格翻訳 (zh / zh_Hant / ko、2026-05-16) 完了。アプリアイコン / Splash は PR #91 で生成済、Pixel 6a 実機表示確認 OK。残: Play Store 提出準備 (Phase 11.9 / 11.10、計画書 [docs/oss-and-play-release-plan.md](docs/oss-and-play-release-plan.md) PR #66 承認済) |
...
最終更新日: 2026-06-17（英語版 Store listing も初回提出範囲に含める方針を反映。英語版 Feature Graphic と en スクリーンショット 7 シナリオを追加済み。Phase 11.9 γ の残りを Play Console 実画面での listing / Data Safety 確定、keystore 後の AAB 検証へ更新）
