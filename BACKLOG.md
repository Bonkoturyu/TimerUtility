...
| 11 (その他) | 未着手 | アプリアイコン / 設定画面 / ダークモード / 実翻訳 / Play Store 提出準備 |
| 12 | 未着手 | 任意 / iOS 版（Android 版完成後） |

---

最終更新日: 2026-05-10（Phase 10.5 完全クローズ — 実機検証済み。Session 1〜5 で Domain / Infrastructure / Application / Presentation 全層 + 配線 + l10n + docs を実装 (PR #18-25)、PR #26 で実機フィードバック対応 (PageView 循環 / 都市 A-Z / ドット pill 化)、PR #27 で SafeArea bottom 追加 (nav バー回避)。Pixel 6a / Android 16 で 6 シナリオ + 上限ガード + ドット視認性すべて OK、504 テストパス）
