...
| 11.8 (OSS 公開) | 進行中 | T1〜T9 PR #67 で main マージ済 (2026-05-16)。残: T8.5 (GitHub Privacy team メール申請、2026-05-17 ユーザ送信済・返信待ち) / T8.6 (404 確認、2026-05-17 時点では 200 OK 継続) / T10 (Public 化) はユーザ作業 |
| 11.9 (Play 提出準備) | 事前検討着手 | branch `phase-11.9-prep` (2026-05-17) — 計画書 [docs/oss-and-play-release-plan.md](docs/oss-and-play-release-plan.md) Phase 11.9 セクションの事前検討 4 件 (A 依存版数 / B applicationId 影響範囲 / C 5 言語アプリ名 / G アイコン仕様) を [docs/phase-11.9-prep-notes.md](docs/phase-11.9-prep-notes.md) に集約 + 実アーティファクト 4 件 (privacy-policy ja/en、play-store-listing、release-signing) を docs/ 配下に草稿作成。Native / pubspec.yaml は未着手。Phase 11.8 完了 → キックオフで `phase-11.9-prep-notes.md` §I 残論点 4 件確定 → T0 (applicationId 変更) 着手予定 |
