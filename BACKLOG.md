...
| 11.8 (OSS 公開) | 進行中 | T1〜T9 着手中 (2026-05-16、branch `phase-11.8-oss-prep`)。README 再構成 / THIRD_PARTY_NOTICES.md / CONTRIBUTING.md / CODE_OF_CONDUCT.md (Contributor Covenant 2.1) / .github/ISSUE_TEMPLATE + PR_TEMPLATE / pubspec.yaml メタフィールド / 秘密情報 grep 完了。642 テスト緑 (1 skipped) 維持。残: T8.5 (GitHub Privacy team メール申請) / T8.6 (404 確認) / T10 (Public 化) はユーザ作業 |
