...
最終更新日: 2026-05-14（BACKLOG.md コンパクト化 — 完了 Phase 0〜10.5 の `[x]` チェックリスト・実機検証詳細を [docs/dev-log.md](docs/dev-log.md) に集約し、本ファイルは Phase ヘッダ + 1 行要約 + dev-log リンク + 進捗サマリ + 進行中/未着手 Phase の詳細のみ保持。790 行 → 316 行）
