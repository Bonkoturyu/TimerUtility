...
- [~] 設定画面（音源選択、デフォルトスヌーズ時間、テーマ手動切替、色覚多様性対応モードなど）
  ...
  - CVD モード: 2026-05-13、PR #39 で完了 (方針 (a) 冗長表示、3 種バナーすべてに
  ...
  - [x] **色覚多様性 (CVD、いわゆる色盲) 対応モード** (2026-05-13、PR #39 完了、方針 (a) 採用): 現状 `permission_banners.dart` の
