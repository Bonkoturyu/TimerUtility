...
| 10.5 | 完了（実機検証済み） | 世界時計。Domain / Infrastructure / Application / Presentation 全層実装 + main.dart 配線 + l10n + docs 更新（Session 1〜5、PR #18-25）。実機検証フィードバック対応 (PageView 循環 / 都市 A-Z / ドット pill 化 / SafeArea で nav bar 回避) は PR #26-27 で完了。2026-05-10、Pixel 6a / Android 16 で 6 シナリオ + 上限ガード + UX 修正の再確認すべて OK、504 テストパス |
| 11 | 未着手 | 任意 |
| 12 | 未着手 | 任意 / iOS 版（Android 版完成後） |

---

最終更新日: 2026-05-10（Phase 10.5 完了 — 実機検証済み。Session 1〜5 で Domain / Infrastructure / Application / Presentation 全層 + 配線 + l10n + docs を実装、PR #26-27 で実機検証フィードバック (PageView 循環 / 都市 A-Z / ドット pill / SafeArea) 反映。Pixel 6a / Android 16 で 6 シナリオ + 上限ガード + UX 再確認すべて OK、504 テストパス）
