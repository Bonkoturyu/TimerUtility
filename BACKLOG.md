...
| 11 (その他) | 進行中 | 設定画面 4 項目 (PR #36) + CVD 冗長表示 (PR #39) + 言語手動切替 UI (2026-05-14) 完了。残: アプリアイコン / 通知 channel 名 i18n / 中韓 ARB 本格翻訳 / Play Store 提出準備 |
...
最終更新日: 2026-05-15（Phase D (Diagnostic Logging) 完了 — D-1 (PR #49) / D-2 (PR #52) / D-3 (PR #51) すべて main マージ済、Pixel 6a 4 シナリオ実機検証 (ファイル生成 / PII 排除 / トグル永続化 / Share Sheet) すべて OK。詳細は [dev-log](docs/dev-log.md)）
