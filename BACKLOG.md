...
| 11 (その他) | 未着手 | アプリアイコン / 設定画面 / 実翻訳 / Play Store 提出準備 |
| 12 | 未着手 | 任意 / iOS 版（Android 版完成後） |

---

最終更新日: 2026-05-13（Phase 6 docs cleanup 完了 — `docs/platform-channels.md` を実装ベースに全面リライト、4 ch (`/notification` / `/alarm_event` / `/boot` / `/lockscreen`) の採用見送りを正式に記録、`clearShowWhenLocked` メソッド (Phase 6 実機検証フォローで後付け追加、docs 未反映だった) を文書化、BACKLOG L180 残課題を [x] 化、Phase 6 行を「完全クローズ」表記に更新。コード変更なし）
