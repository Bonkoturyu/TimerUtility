...
- [~] Play Store 提出準備（Phase 11.9 γ）:
  ...
  GitHub Pages は Source = `main` / `/docs` 保存済み。残りは公開 URL 確認、
...
最終更新日: 2026-06-16（Phase 11.9 β の Pixel 6a 実機確認完了、POST_NOTIFICATIONS
follow-up の実機確認完了、γ の signing 配線 / version bump / GitHub Pages source
保存済み状態へ同期）
