...
| 11 (その他) | 進行中 | 設定画面 4 項目 (PR #36) + CVD 冗長表示 (PR #39) + 言語手動切替 UI (2026-05-14) + 通知 channel 名 i18n (PR #59、2026-05-16) + F-7 Manifest 整形 (PR #59) 完了。残: アプリアイコン / 中韓 ARB 本格翻訳 / Play Store 提出準備 |
